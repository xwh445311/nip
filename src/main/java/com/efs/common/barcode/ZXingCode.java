package com.efs.common.barcode;
...
public class ZXingCode
{
     ...
     * @throws Exception
     */
    public static BufferedImage getCodeImage(File logoFile,String content,String note) throws Exception
    {
