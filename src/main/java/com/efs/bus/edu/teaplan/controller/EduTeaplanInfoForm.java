...
/**
 * 
 * com.efs.bus.edu.teaplan.controller.EduTeaplanInfoForm
 * @author xwh
 * 2018-05-22 14:33:08
 * 教案检查信息表
 *
 */
public class EduTeaplanInfoForm
{
	/**
	 * 系统主键
	 */
	private String tiDbId;
	...
	/**
	 * 系统主键<br/>
	 * @return String tiDbId
	 */
	public String getTiDbId()
	{
		return tiDbId;
	}
	 ...
	 * @param Long tiDbId
	 */
	public void setTiDbId(String tiDbId)
	{
		this.tiDbId = tiDbId;
	}
	...
	/**
	 * 评价分数<br/>
	 * @return String tiEvalScore
	 */
	public String getTiEvalScore()
	{
		return tiEvalScore;
	}
	 ...
	 */
	public void setTiEvalScore(String tiEvalScore)
	{
