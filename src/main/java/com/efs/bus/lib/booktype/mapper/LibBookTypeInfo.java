...
/**
 * 
 * com.efs.bus.lib.booktype.mapper.LibBookTypeInfo
 * @author xuwh
 * 2018-03-25 23:08:05
 * 图书类别信息表
 *
 */
public class LibBookTypeInfo implements Serializable
{
	/**
	 * 类别ID
	 */
	 ...
	 * 子类别
	 */
	private List<LibBookTypeInfo> children;


	public List<LibBookTypeInfo> getChildren()
	{
		return children;
	}

	public void setChildren(List<LibBookTypeInfo> children)
	{
