...
<section>
    ...
    <div class="main-content" >
        ...
        <div class="wrapper">
            ...
            <form action="<%=basePath%>/sysadmin/noteInfo/addTsNoteInfo.do" role="form" id="noteForm">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" style="padding: 5px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ntHead" id="ntHead" maxlength="50" placeholder="請輸入消息主旨">
                            </div>
                    </div>
